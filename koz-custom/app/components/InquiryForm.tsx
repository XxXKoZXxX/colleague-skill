  ...
  if (state.success) {
    return (
      <div className="flex flex-col items-center gap-4 py-12 text-center">
        ...
        <h2 className="text-2xl font-semibold text-emerald-400">Inquiry Submitted!</h2>
  ...
  return (
    <form action={action} className="flex flex-col gap-6">
      ...
      <Field
        ...
        placeholder="500"
        hint="Minimum $200"
        errors={state.fieldErrors?.budget_usd}
        required
      />
      ...
      >
        {pending ? <><Loader2 className="w-4 h-4 animate-spin" /> Submitting…</> : 'Submit Custom Inquiry'}
      </button>
    </form>
  )
}
